...
st.markdown(
    "Ajusta los parámetros en la barra lateral para ver cómo cambia la concentración de Calcio libre en función del pH."
)
...
P_total_inicial = st.sidebar.slider(
    "Concentración total de Fósforo (P_total) [M]",
    0.001,
    0.1,
    0.01,
    step=0.001,
...
Kps_exponente = st.sidebar.slider(
    "Exponente del Kps (10^-x)", 5.0, 10.0, 6.6, step=0.1
)  # 2.5e-7 es aprox 10^-6.6
